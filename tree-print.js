...
// ВАЖНО: обработчики кнопок печати обращаются к DOM-элементам
// (#btn-print, #print-cancel, #print-go, .print-opt), которых ещё нет
// в момент разбора этого файла (подключается в <head> до разметки
// <body>). Регистрация обработчиков обёрнута в DOMContentLoaded сразу,
// а не постфактум — в отличие от tree-print.js рабочего проекта
// (mostovoy-tree), где для этого потребовался отдельный фикс
// (коммит c9e24eb).
// ════════════════════════════════════════════════════════

// tree-layout.js — layout-алгоритм и рендер SVG-дерева
// Вынесено из tree_template.html для уменьшения размера основного файла
// Зависит от глобалов, определяемых в главном файле: IDX, FALLBACK_DATA,
// currentLang, pname(), t(), tr(), _sessionPassword. Не содержит кода,
// исполняемого на верхнем уровне при загрузке — только const/function —
// поэтому порядок подключения относительно других <script src> не важен.
